...
# -------------------------------------------------
model_40x  = load_model("models/cnn_40x.pth")
model_100x = load_model("models/cnn_100x.pth")
model_200x = load_model("models/cnn_200x.pth")
model_400x = load_model("models/cnn_400x.pth")
